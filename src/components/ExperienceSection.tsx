      ...
      <div className="flex flex-col gap-2">
        {experiences.map((exp, i) => (
          <Link
            ...
            className="group grid grid-cols-1 sm:grid-cols-[140px_1fr] gap-1 sm:gap-6 p-4 -mx-4 rounded-lg transition-all duration-200 hover:bg-surface/60 hover:shadow-[inset_0_1px_0_0_rgba(148,163,184,0.1)] hover:drop-shadow-lg"
          >
